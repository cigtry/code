...
HD_PWD='D:/DESKTOP/code/IMG/IMG.runs/zynq_v_vid_in_axi4s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_v_vid_in_axi4s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_v_vid_in_axi4s_0_0.tcl
