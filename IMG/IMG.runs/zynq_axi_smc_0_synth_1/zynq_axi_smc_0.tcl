...
read_ip -quiet D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/DESKTOP/code/IMG/IMG.runs/zynq_axi_smc_0_synth_1 -new_name zynq_axi_smc_0 -ip [get_ips zynq_axi_smc_0]]
...
if { [catch {
  file copy -force D:/DESKTOP/code/IMG/IMG.runs/zynq_axi_smc_0_synth_1/zynq_axi_smc_0.dcp D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/DESKTOP/code/IMG/IMG.runs/zynq_axi_smc_0_synth_1/zynq_axi_smc_0_stub.v D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/DESKTOP/code/IMG/IMG.runs/zynq_axi_smc_0_synth_1/zynq_axi_smc_0_stub.vhdl D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/DESKTOP/code/IMG/IMG.runs/zynq_axi_smc_0_synth_1/zynq_axi_smc_0_sim_netlist.v D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/DESKTOP/code/IMG/IMG.runs/zynq_axi_smc_0_synth_1/zynq_axi_smc_0_sim_netlist.vhdl D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/DESKTOP/code/IMG/IMG.ip_user_files/ip/zynq_axi_smc_0]} {
  catch { 
    file copy -force D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_stub.v D:/DESKTOP/code/IMG/IMG.ip_user_files/ip/zynq_axi_smc_0
  }
}

if {[file isdir D:/DESKTOP/code/IMG/IMG.ip_user_files/ip/zynq_axi_smc_0]} {
  catch { 
    file copy -force D:/DESKTOP/code/IMG/IMG.srcs/sources_1/bd/zynq/ip/zynq_axi_smc_0/zynq_axi_smc_0_stub.vhdl D:/DESKTOP/code/IMG/IMG.ip_user_files/ip/zynq_axi_smc_0
  }
}
