...
HD_PWD='D:/DESKTOP/code/IMG/IMG.runs/zynq_cmos_capture_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_cmos_capture_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_cmos_capture_0_0.tcl
