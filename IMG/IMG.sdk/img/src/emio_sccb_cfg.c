...
void emio_init(void)
{
	...
	XGpioPs_SetDirectionPin(&gpiops_inst, EMIO_COMS_PWDN, 1);
	XGpioPs_SetDirectionPin(&gpiops_inst, EMIO_COMS_RSTN, 1);
	XGpioPs_SetDirectionPin(&gpiops_inst, EMIO_COMS_CFG_DONE, 1);
	//使能sccb端口 输出
	XGpioPs_SetOutputEnablePin(&gpiops_inst, EMIO_SCL_NUM, 1);
	XGpioPs_SetOutputEnablePin(&gpiops_inst, EMIO_SDA_NUM, 1);
	XGpioPs_SetOutputEnablePin(&gpiops_inst, EMIO_COMS_PWDN, 1);
	XGpioPs_SetOutputEnablePin(&gpiops_inst, EMIO_COMS_RSTN, 1);
	XGpioPs_SetOutputEnablePin(&gpiops_inst, EMIO_COMS_CFG_DONE, 1);
	//将sccb的SCLK和SDA都拉高
	XGpioPs_WritePin(&gpiops_inst, EMIO_COMS_CFG_DONE, 0);
	XGpioPs_WritePin(&gpiops_inst, EMIO_SCL_NUM, 1);
	XGpioPs_WritePin(&gpiops_inst, EMIO_SDA_NUM, 1);
	XGpioPs_WritePin(&gpiops_inst, EMIO_COMS_PWDN, 0);
	XGpioPs_WritePin(&gpiops_inst, EMIO_COMS_RSTN, 1);
...
void ov5640_config_done(void)
{
	usleep(4);
	XGpioPs_WritePin(&gpiops_inst, EMIO_COMS_CFG_DONE, 1);
}
